...
def replace(file, numerals):
    ...
    test = "សៀវភៅ សេចក្តីពិតដែលនាំទៅរកជីវិតអស់កល្បជានិច្ច ចេញផ្សាយឆ្នាំ 1968"
    ...
    for index, row in dictionary.iterrows():
        ...
        if contains_numerals:
            ...
            print(index, new_string)

if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("You did not provide the source file and target numerals as argument. Put them after this .py file")
        exit()
    source = sys.argv[1]
    target = sys.argv[2]
