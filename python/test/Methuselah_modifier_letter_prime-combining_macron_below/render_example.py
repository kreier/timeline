...
def measure_section(header_text, header_font, main_text, main_font):
    ...
    return width, height, header_bbox[3]-header_bbox[1]
...
# Final image size
width = max(aptos_w, noto_w, segoe_w) + 20
height = aptos_h + noto_h + segoe_h + consolas_h + 90  # spacing between sections
...
y += segoe_h + 30   # move down after Segoe section
