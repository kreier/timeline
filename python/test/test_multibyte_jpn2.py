...
class JapaneseFontTests(unittest.TestCase):
    ...
    def test0(self):
        ...
        c = Canvas(outputfile('test_multibyte_jpn2.pdf'))
...
##        finished = time.clock()
        ...
        if VERBOSE:
            print('saved test_multibyte_jpn2.pdf')
    ...
    def ___test2_all(self):
        ...
        c.save()
        if VERBOSE:
            print('saved '+outputfile('test_multibyte_jpn2.pdf'))
