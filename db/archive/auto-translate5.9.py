# Create a google translated dictionary as starting point for a new language - only new 72 entries for timeline 5.9
...
def import_reference():
    ...
    dict = pd.read_csv("./dictionary_reference59.csv")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        exit()
    language = sys.argv[1]
    filename = "./dictionary_" + language + "59.csv"
